// cert-renamer-v2 — V2-binären. Endast wiring: konfig, databas, HTTP-server,
// browser-launch och graceful shutdown. All logik bor i internal/v2/*.
package main
...
func run(logger *slog.Logger, noBrowser bool) error {
	...
	defer db.Close()
	logger.Info("databas initierad", "path", v2store.DBPath())
